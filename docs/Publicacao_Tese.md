...
+Trabalho resultado de projeto de Iniciação Científica (IC) no Laboratório Multidisciplinar em Alimentação e Saúde (LabMAS), Faculdade de Ciências Aplicadas (FCA), Universidade Estadual de Campinas (UNICAMP), 2023–2025.
**Autores:** Éllis Wollis Malta Abhulime¹, Profa. Dra. Fabiana Braga Benatti²

**Afiliações:**
- 1. Laboratório Multidisciplinar em Alimentação e Saúde (LabMAS), Faculdade de Ciências Aplicadas, Universidade Estadual de Campinas (Campinas, SP, Brasil) — Éllis Wollis Malta Abhulime (Bolsista de IC, 2023–2025)
- 2. Profa. Dra. Orientadora de IC, Laboratório Multidisciplinar em Alimentação e Saúde (LabMAS), Faculdade de Ciências Aplicadas, Universidade Estadual de Campinas (Campinas, SP, Brasil) — Fabiana Braga Benatti
...
*   **Figura 4: Idade vs Consumo de Cafeína (mg).**
    ![Figura 4: Idade vs Consumo de Cafeína](notebooks/outputs/figura_ad_idade_vs_mg_cafeina_dia.png)
...
A ausência de correlação entre cafeína e horas de jogo (H2, ρ = 0.0460) sugere que a duração do jogo, por si só, não dita o consumo de cafeína nesta amostra, que pode ser influenciado por outros fatores como intensidade percebida ou hábitos individuais [@ref3].

As associações entre maior consumo de cafeína e a ocorrência de insônia (H3, p=0.0152) e dor de estômago (H3, p=0.0092) são consistentes com os efeitos colaterais conhecidos da substância [@ref3], reforçando a necessidade de moderação. Outros efeitos adversos investigados não mostraram associação significativa.

Confirmou-se que jogadores que consomem cafeína para melhorar a performance (H4) ingerem doses significativamente maiores, alinhando-se com a percepção da cafeína como ergogênico em esports [@ref8; @ref9]. A plataforma de jogo (H5) não se associou a efeitos adversos, e não houve diferença significativa no consumo de cafeína entre gêneros masculino e feminino (H6).
