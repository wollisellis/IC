...
`Os valores recalculados de consumo diário e semanal de cafeína foram armazenados em novas colunas (`MG_CAFEINA_TOTAL_DIA_RECALCULADA` e `MG_CAFEINA_TOTAL_SEMANA_RECALCULADA`) no arquivo IC_Dados_Curados_Cafeina_Recalculada_v3.csv, permitindo comparações com os cálculos originais e servindo de base para as análises reportadas neste estudo que utilizam a variável de consumo de cafeína.`
